...
`GEMINI.md` is the **Global Ruler** and core source of truth for this system. It defines the mandate of the **Director (Senior Principal Engineer)** and establishes the strategic foundation for all operations. 

Every action taken by the agent must align with the philosophy and constraints defined in `GEMINI.md`.

Directory: C:\Users\USER\.gemini\
...
## 🛠 Project Structure
- `./.agent/GEMINI.md`: Global protocol and mandate.
- `./.agent/workflows/`: Specialized markdown files defining the execution steps for each slash command.
